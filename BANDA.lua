...
sudo_users = {SUDO,1721540719,1931283050 , 1925008261, 45778, 335, 45787}   
...
var = true 
elseif tonumber(user_id) == tonumber( 1925008261) then
var = true  
elseif tonumber(user_id) == tonumber(1931283050 ) then
var = true  
...
local UserName = (data.username_ or "SOURCE_ELKIMA")
...
send(msg.chat_id_, msg.id_,' ◍ اصدار سورس القمه{ S:12✓}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/ELKIMA_2"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SOURCE_ELKIMA)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/SOURCE_ELKIMA"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '✹𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙺𝙸𝙼𝙰', url="t.me/SOURCE_ELKIMA"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "القمه")
...
send(msg.chat_id_,0," ◍ الـعـضو  : {["..data.first_name_.."](T.ME/SOURCE_ELKIMA)}\n ◍ ["..BANDA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◍ عذرا  ⇠ {["..data.first_name_.."](T.ME/SOURCE_ELKIMA)}\n ◍ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
┍━━━━━☛ 𝙴𝙻𝙺𝙸𝙼𝙰 ☚━━━━━┑
🔰𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙺𝙸𝙼𝙰
🔰𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙻𝚈
🔰𝚂𝙿𝙴𝙴𝙳 𝙰𝙲𝙲𝚄𝚁𝙰𝙲𝚈 𝚂𝙰f𝙴𝚃𝚈
┕━━━━━☛ 𝙴𝙻𝙺𝙸𝙼𝙰 ☚━━━━━┙
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✹𝙳𝚅 𝙺𝙾𝚁𝚈𖠊',url="t.me/Bedo11111"},{text = '✹𝐃𝐄𝐕 𝐌𝐄𝐒𝐒𝐈!',url="t.me/Messi_ElKBer"}},
{{text = '✹𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙺𝙸𝙼𝙰', url="t.me/SOURCE_ELKIMA/270"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SOURCE_ELKIMA&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙳𝚅 𝙼𝙴𝚂𝚂𝙸', url="t.me/Messi_ElKBer"},{text = '𝐃𝐕 𝐊𝐎𝐑𝐘', url="t.me/Bedo11111"}},
{{text = ' 𝐓𝐖 𝙴𝙻𝙺𝙸𝙼𝙰', url="t.me/ELKIMA_BOT"}}, 
{{text = '𝐖𝐄𝐋𝐂𝐌𝐄 𝙴𝙻𝙺𝙸𝙼𝙰', url="t.me/SOURCE_ELKIMA"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✹𝙳𝚅 𝙺𝙾𝚁𝚈𖠊',url="t.me/Bedo11111"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[ 
[قناه سورس القمه ادخل وتابع الجديد](t.me/SOURCE_ELKIMA)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '✹𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙺𝙸𝙼𝙰', url="t.me/SOURCE_ELKIMA"}}, 
...
if text == 'العاب القمه' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ◍ اهلا في قائمه الالعاب المتطوره سورس القمه ◍ 
...
if tonumber(result.sender_user_id_) == tonumber( 1925008261) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1931283050 ) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber( 45778) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber( 45787) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber( 335) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n ◍ الـعـضو   ⇠ ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ELKIMA')..')'
...
if result.id_ == tonumber( 1925008261) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1931283050 ) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber( 335) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber( 45778) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber( 45787) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n ◍ الـعـضو   ⇠ ['..result.title_..'](t.me/'..(username or 'SOURCE_ELKIMA')..')'
status  = '\n ◍ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber( 1925008261) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1931283050 ) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber( 335) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber( 45778) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber( 45787) then  
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
send(msg.chat_id_, msg.id_," ◍ عذرا الملف لايدعم سورس القمه\n") 
end
return false
end
...
if text == ("مسح قائمه القمه") and Sudo(msg) then
...
if text == ("رفع القمه") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع القمه@(.*)$") and Sudo(msg) then
local username = text:match("^رفع القمه@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع القمه(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع القمه(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل القمه") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل القمه@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل القمه@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل القمه(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل القمه(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, t..'●○━━━━𝙴𝙻𝙺𝙸𝙼𝙰━━━━○●\nاضغط علي الاسم ليتم نسخه\n●○━━━━𝙴𝙻𝙺𝙸𝙼𝙰━━━━○●ٴ\n ◍ ◍ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'القمه').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'القمه')
local BANDA_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'القمه').." غادر" or text == 'غادر' then  
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري نور عنيا🥺🤍](t.me/SOURCE_ELKIMA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني 😍💚](t.me/SOURCE_ELKIMA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝💘](t.me/SOURCE_ELKIMA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/SOURCE_ELKIMA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/SOURCE_ELKIMA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SOURCE_ELKIMA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SOURCE_ELKIMA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SOURCE_ELKIMA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز ابن ناس 😊 ](t.me/SOURCE_ELKIMA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ عضو قميل 🌝💘 ](t.me/SOURCE_ELKIMA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه القمه ') 
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/SOURCE_ELKIMA)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/SOURCE_ELKIMA)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..☆♥️](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/SOURCE_ELKIMA)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤☆](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..☆💕](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..☆💕](t.me/SOURCE_ELKIMA)')
return false
end
end
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'القمه')
