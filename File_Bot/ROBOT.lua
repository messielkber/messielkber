...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه روبوت') 
return false
end
...
if text == 'الملفات' or text == 'اوامر الملفات' then
local my_ph = bot_data:get(ban_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_,"  ") 
return false  
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/errrrrrro)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/errrrrrro)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..☆♥️](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/errrrrrro)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ون كمن اوي🥺♥️](t.me/errrrrrro)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤☆](t.me/errrrrrro)')
return false
end
end
end
